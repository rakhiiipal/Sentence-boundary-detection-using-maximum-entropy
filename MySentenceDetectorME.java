 ...
 */
public class MySentenceDetectorME implements SentenceDetector {
   ...
   */
  public MySentenceDetectorME(String language) throws IOException {
   ...
   */
  public MySentenceDetectorME(SentenceModel model) {
   ...
   */
  public MySentenceDetectorME(SentenceModel model, Factory factory) {
    this.model = model.getMaxentModel();
  ...
  public static SentenceModel train(String languageCode,
	...
	//SentenceSample ss=null;
	//while( ( ss= samples.read() ) != null ){
	//System.out.println(ss.getDocument());
	//}
    System.out.println("sdFacrory="+sdFactory);
	DefaultEndOfSentenceScanner eosscanner=(DefaultEndOfSentenceScanner)sdFactory.getEndOfSentenceScanner();
	char[]  eoschar=eosscanner.getEndOfSentenceCharacters();
	for(int i=0; i< eoschar.length; i++)
	{
		System.out.println(eoschar[i]);
	}
	
	DefaultSDContextGenerator  dcg=(DefaultSDContextGenerator)sdFactory.getSDContextGenerator());
