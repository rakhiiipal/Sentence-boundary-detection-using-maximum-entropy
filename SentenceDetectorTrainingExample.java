...
public class SentenceDetectorTrainingExample {
	...
	/**
	 * This method generates s custom model file for sentence detection, in
	 * directory "custom_models".
	 * The training data used is "trainingDataSentences.txt". Training data contains
	 * a sentence per line in the text file.
	 * 
	 * @throws IOException
	 */
	public void trainSentDectectModel() throws IOException {
		...
		// save the model, to a file, "en-sent-custom.bin", in the destDir :
		// "custom_models"
